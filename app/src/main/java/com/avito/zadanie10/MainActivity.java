...
public class MainActivity extends AppCompatActivity {
    public static final String IMAGE_URL_BASE = "https://covers.openlibrary.org/b/id/";
    ...
    private class BookHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            intent.putExtra(BookDetailsActivity.EXTRA_TITLE, bookTitleTextView.getText());
            intent.putExtra(BookDetailsActivity.EXTRA_AUTHOR, bookAuthorTextView.getText());
            intent.putExtra(BookDetailsActivity.EXTRA_COVER, book.getCover());
